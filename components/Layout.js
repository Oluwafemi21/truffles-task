    ...
    return (
        <div className="min-h-screen flex bg-grey">
                    ...
                    <ul className="px-4">
                        {menuItems.map(({ href, title }) => (
                            <li className="m-2" key={title}>
                                <Link
                                    href={href}
                                    className={`flex py-2 px-4 text-navy rounded hover:bg-white cursor-pointer`}
                                >
                                    {title}
                                </Link>
                            </li>
            ...
            <div className="flex flex-col flex-1">
                <header className="h-[83px] px-6 sticky top-0 flex justify-between items-center border-b border-b-gray-300">
