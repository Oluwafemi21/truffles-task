...
export default function Home() {
    return (
        <>
            ...
            <>
                <section className="bg-primary rounded-md mt-2 px-4 py-2 text-white flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-exclamation-circle h-5 w-5 font-bold stroke-2"
                            viewBox="0 0 16 16"
                        >
